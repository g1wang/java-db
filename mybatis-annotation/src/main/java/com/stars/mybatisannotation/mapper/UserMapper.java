package com.stars.mybatisannotation.mapper;

import static com.stars.mybatisannotation.mapper.UserDynamicSqlSupport.*;
...
public interface UserMapper {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, userId, username, mail, phone);
